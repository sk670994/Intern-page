...
export default function TechnologiesSection() {
  return (
    <section className="w-full bg-white py-[40px] flex justify-center">
      <div className="w-[1280px] flex flex-col items-center gap-[32px] overflow-hidden">
        <h1 className="font-['Montserrat'] font-bold text-[36px] text-gray-800 text-center">
          Our Technologies
        </h1>

        <div className="grid grid-cols-6 gap-4 auto-rows-min w-full">
          {/* Each card below uses an image */}
          <div className="col-span-3 h-[194px]">
            <TechnologyCard
          ...
          <div className="col-span-2 h-[194px]">
            <TechnologyCard
              title="AI/ML"
          ...
          <div className="col-span-4 h-[194px]">
            <TechnologyCard
              title="IOT"
